...
function Textarea(props) {
    ...
    function del_img(del_img) {
        ...
        setImg_input(img_input.filter((img_, index) => img_ !== del_img));
    }
        ...
        <div className="row  ">
            ...
            <div className="row col-10 left ">
                ...
                <div className="col-11 center">
                    <div className="row">
                        <div className="col-9">
                            <textarea id="textarea" className="form-control" value={image} rows={image.split("\n").length} aria-describedby="basic-addon1" onChange={(event) => setImage(event.target.value)} />
                        </div>
                        <div className="col-3">
                            <Button
                                variant="primary"
